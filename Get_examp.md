...
В открывшемя окне после вашего никнейма вводим красивое название репозитория и внизу жмем зеленую кнопку 
...
Тепеоь переходим в VSCode и в строке терминала вставляем все что скопировали и...
...
Для этого находим на GitHub то что нам интересное, напимер в поиске, нажимаем на нужный репозиторий и выбираем зеленую кнопку `Code`:
...
Теперь можно смело клонировать данный репозиторий `git clone ИНТРНЕТ АДРЕС`, к себе в компьютер и начать работать в нем, прада программисты решили, что правильнее всего это делать в отдельной ветке `git branch NewBranch`.

По завершении работы отправляем изменения на GitHub, где появляется запись 
