...
Для того, чтобы программисты могли разрабатывать и хранить свои репозитории в Интернете было создано несколько специалных сайтов, самым популярным среди них считается GitHub.
...
Тепеоь переходим в VSCode и в строке терминала вставляем все что скопировали и, УРА! 
...
NanobyteStyle☺. Теперь мы и ветки разобрали!
